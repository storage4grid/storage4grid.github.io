...
|  D2.1  |  Initial Storage Scenarios and Use Cases  |  Feb 2017  |  PU  |  <a hidden="true" href="{{site.baseurl}}/deliverables/storage4grid-D2.1.pdf"><i class="fa fa-file-pdf-o fa-2x" style="color:#DD4B39" aria-hidden="true"></i></a>  | 
|  D2.2  |  Final Storage Scenarios and Use Cases  |  May 2018  |  PU  |  <a hidden="true" href="{{site.baseurl}}/deliverables/storage4grid-D2.2.pdf"><i class="fa fa-file-pdf-o fa-2x" style="color:#DD4B39" aria-hidden="true"></i></a>  | 
...
|  D2.5  |  Initial Lessons Learned and Requirements Reports  |  May 2017  |  PU  |  <a hidden="true" href="{{site.baseurl}}/deliverables/storage4grid-D2.5.pdf"><i class="fa fa-file-pdf-o fa-2x" style="color:#DD4B39" aria-hidden="true"></i></a>  | 
|  D2.6  |  Updated Lessons Learned and Requirements Reports  |  May 2018  |  PU  |  <a hidden="true" href="{{site.baseurl}}/deliverables/storage4grid-D2.6.pdf"><i class="fa fa-file-pdf-o fa-2x" style="color:#DD4B39" aria-hidden="true"></i></a>  | 
...
|  D3.1  |  Initial Storage4Grid Architecture, Interfaces and Model Specifications  |  Aug 2017  |  PU  |  <a hidden="true" href="{{site.baseurl}}/deliverables/storage4grid-D3.1.pdf"><i class="fa fa-file-pdf-o fa-2x" style="color:#DD4B39" aria-hidden="true"></i></a>  | 
|  D3.2  |  Updated Storage4Grid Architecture, Interfaces and Model Specifications  |  Aug 2018  |  PU  |  <a hidden="true" href="{{site.baseurl}}/deliverables/storage4grid-D3.2.pdf"><i class="fa fa-file-pdf-o fa-2x" style="color:#DD4B39" aria-hidden="true"></i></a>  | 
...
|  D4.1  |  Initial User-side ESS control algorithm prototype  |  Aug 2017  |  PU  |  <a hidden="true" href="{{site.baseurl}}/deliverables/storage4grid-D4.1.pdf"><i class="fa fa-file-pdf-o fa-2x" style="color:#DD4B39" aria-hidden="true"></i></a>  | 
...
|  D4.11  |  Initial Energy Router  |  Oct 2018  |  PU  |  <a hidden="true" href="{{site.baseurl}}/deliverables/storage4grid-D4.11.pdf"><i class="fa fa-file-pdf-o fa-2x" style="color:#DD4B39" aria-hidden="true"></i></a>  | 
...
|  D4.2  |  Updated User-side ESS control algorithm prototype  |  May 2018  |  PU  |  <a hidden="true" href="{{site.baseurl}}/deliverables/storage4grid-D4.2.pdf"><i class="fa fa-file-pdf-o fa-2x" style="color:#DD4B39" aria-hidden="true"></i></a>  | 
...
|  D4.4  |  Initial Grid-side ESS control algorithm prototype  |  Jul 2018  |  PU  |  <a hidden="true" href="{{site.baseurl}}/deliverables/storage4grid-D4.4.pdf"><i class="fa fa-file-pdf-o fa-2x" style="color:#DD4B39" aria-hidden="true"></i></a>  | 
...
|  D4.6  |  Initial Cooperative EV charging station control algorithms   |  Aug 2018  |  PU  |  <a hidden="true" href="{{site.baseurl}}/deliverables/storage4grid-D4.6.pdf"><i class="fa fa-file-pdf-o fa-2x" style="color:#DD4B39" aria-hidden="true"></i></a>  | 
...
|  D4.8  |  Initial USM Extensions for Storage Systems  |  Aug 2017  |  PU  |  <a hidden="true" href="{{site.baseurl}}/deliverables/storage4grid-D4.8.pdf"><i class="fa fa-file-pdf-o fa-2x" style="color:#DD4B39" aria-hidden="true"></i></a>  | 
|  D4.9  |  Updated USM Extensions for Storage Systems  |  Aug 2018  |  PU  |  <a hidden="true" href="{{site.baseurl}}/deliverables/storage4grid-D4.9.pdf"><i class="fa fa-file-pdf-o fa-2x" style="color:#DD4B39" aria-hidden="true"></i></a>  | 
|  D5.1  |  Initial DSF Hybrid Simulation Engine  |  Feb 2018  |  PU  |  <a hidden="true" href="{{site.baseurl}}/deliverables/storage4grid-D5.1.pdf"><i class="fa fa-file-pdf-o fa-2x" style="color:#DD4B39" aria-hidden="true"></i></a>  | 
...
|  D5.3  |  Initial DSF Connectors for external systems and services  |  Aug 2017  |  PU  |  <a hidden="true" href="{{site.baseurl}}/deliverables/storage4grid-D5.3.pdf"><i class="fa fa-file-pdf-o fa-2x" style="color:#DD4B39" aria-hidden="true"></i></a>  | 
|  D5.4  |  Updated DSF Connectors for external systems and services  |  Aug 2018  |  PU  |  <a hidden="true" href="{{site.baseurl}}/deliverables/storage4grid-D5.4.pdf"><i class="fa fa-file-pdf-o fa-2x" style="color:#DD4B39" aria-hidden="true"></i></a>  | 
...
|  D5.6  |  Initial DSF Predictive Models  |  Aug 2018  |  PU  |  <a hidden="true" href="{{site.baseurl}}/deliverables/storage4grid-D5.6.pdf"><i class="fa fa-file-pdf-o fa-2x" style="color:#DD4B39" aria-hidden="true"></i></a>  | 
...
|  D6.1  |  Phase 1 Test Site Plans  |  Jul 2017  |  PU  |  <a hidden="true" href="{{site.baseurl}}/deliverables/storage4grid-D6.1.pdf"><i class="fa fa-file-pdf-o fa-2x" style="color:#DD4B39" aria-hidden="true"></i></a>  | 
|  D6.10  |  Phase 1 Evaluation Report  |  Nov 2017  |  PU  |  <a hidden="true" href="{{site.baseurl}}/deliverables/storage4grid-D6.10.pdf"><i class="fa fa-file-pdf-o fa-2x" style="color:#DD4B39" aria-hidden="true"></i></a>  | 
...
|  D6.4  |  Phase 1 Test Site Platforms and Deployments Report  |  Sep 2017  |  PU  |  <a hidden="true" href="{{site.baseurl}}/deliverables/storage4grid-D6.4.pdf"><i class="fa fa-file-pdf-o fa-2x" style="color:#DD4B39" aria-hidden="true"></i></a>  | 
...
|  D6.7  |  Initial Interfaces for Professional and Residential Users  |  Aug 2017  |  PU  |  <a hidden="true" href="{{site.baseurl}}/deliverables/storage4grid-D6.7.pdf"><i class="fa fa-file-pdf-o fa-2x" style="color:#DD4B39" aria-hidden="true"></i></a>  | 
|  D6.8  |  Updated Interfaces for Professional and Residential Users  |  Aug 2018  |  PU  |  <a hidden="true" href="{{site.baseurl}}/deliverables/storage4grid-D6.8.pdf"><i class="fa fa-file-pdf-o fa-2x" style="color:#DD4B39" aria-hidden="true"></i></a>  | 
...
|  D7.1  |  Communication and Dissemination Strategy  |  Feb 2017  |  PU  |  <a hidden="true" href="{{site.baseurl}}/deliverables/storage4grid-D7.1.pdf"><i class="fa fa-file-pdf-o fa-2x" style="color:#DD4B39" aria-hidden="true"></i></a>  | 
|  D7.2  |  Project Website  |  Feb 2017  |  PU  |  <a hidden="true" href="{{site.baseurl}}/deliverables/storage4grid-D7.2.pdf"><i class="fa fa-file-pdf-o fa-2x" style="color:#DD4B39" aria-hidden="true"></i></a>  | 
